...
ActiveRecord::Schema.define(version: 20190119180659) do
  ...
  create_table "contacts_test", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
